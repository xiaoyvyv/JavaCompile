...
package com.xiaoyv.java.compile.view.console;
...
public class ConsoleEditText extends AppCompatEditText {
    ...
    // set scrollview to auto fling bottom
    ...
    private void createIOStream() {
        mReceiveBuffer = new byte[IntegerQueue.QUEUE_SIZE];
        mStdoutBuffer = new ByteQueue(IntegerQueue.QUEUE_SIZE);
        mStderrBuffer = new ByteQueue(IntegerQueue.QUEUE_SIZE);
