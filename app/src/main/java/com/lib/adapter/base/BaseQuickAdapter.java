...
import com.lib.adapter.base.animation.AlphaInAnimation;
import com.lib.adapter.base.animation.BaseAnimation;
import com.lib.adapter.base.animation.ScaleInAnimation;
import com.lib.adapter.base.animation.SlideInBottomAnimation;
import com.lib.adapter.base.animation.SlideInLeftAnimation;
import com.lib.adapter.base.animation.SlideInRightAnimation;
import com.lib.adapter.base.entity.IExpandable;
import com.lib.adapter.base.loadmore.LoadMoreView;
import com.lib.adapter.base.loadmore.SimpleLoadMoreView;
import com.lib.adapter.base.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void setEmptyView(int layoutResId, @NonNull ViewGroup viewGroup) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(layoutResId, viewGroup, false);
        setEmptyView(view);
    }

    public void setEmptyView(Context context, String text) {
        View emptyView = LayoutInflater.from(context).inflate(R.layout.view_empty_view, getRecyclerView(), false);
        TextView tips = emptyView.findViewById(R.id.tips);
        if (!StringUtils.isEmpty(text)) tips.setText(text);
     ...
     * @param itemBean The item that needs to be displayed.
     */
    protected abstract void convert(K holder, T itemBean);
