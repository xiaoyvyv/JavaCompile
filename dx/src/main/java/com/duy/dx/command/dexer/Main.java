...
public class Main {
     ...
     */
    public static int main(String[] argArray) throws Exception {
        ...
        if (result != 0) {
            ...
            String errorFile = fileNames[0];
            throw new Error("请检查出错文件 " + new File(errorFile).getName(), new Throwable(errorFile));
        }
        return result;
    }
