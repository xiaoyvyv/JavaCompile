...
class AccessorGenerator implements ClassFileConstants {
    ...
    protected static boolean canWidenTo(Class type, Class otherType) {
        ...
        if (type == Boolean.TYPE) {
            return otherType == Boolean.TYPE;
        } else if (type == Byte.TYPE) {
            return otherType == Byte.TYPE
            ...
            return otherType == Short.TYPE
                    || otherType == Integer.TYPE
                    || otherType == Long.TYPE
                    || otherType == Float.TYPE
                    || otherType == Double.TYPE;
        } else if (type == Character.TYPE) {
            return otherType == Character.TYPE
                    || otherType == Integer.TYPE
                    || otherType == Long.TYPE
                    || otherType == Float.TYPE
                    || otherType == Double.TYPE;
        } else if (type == Integer.TYPE) {
            return otherType == Integer.TYPE
                    || otherType == Long.TYPE
                    || otherType == Float.TYPE
                    || otherType == Double.TYPE;
        } else if (type == Long.TYPE) {
            return otherType == Long.TYPE
                    || otherType == Float.TYPE
                    || otherType == Double.TYPE;
        } else if (type == Float.TYPE) {
            return otherType == Float.TYPE
                    || otherType == Double.TYPE;
        } else if (type == Double.TYPE) {
            return otherType == Double.TYPE;
        }
